...
var Admin = `<html lang="zh-cn">
    ...
    <head>
        ...
        <title>账号管理</title>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/kristyzhy/static/layui/css/layui.css">
        <script src="https://cdn.jsdelivr.net/gh/kristyzhy/static/layui/layui.all.js"></script>
    </head>
...
<div class="hytq">
    <ul>
        <li><img src="./icon-jinbi.png" /><p>每日京豆</p></li>
        <li><img src="./icon-shenjuan.png" /><p>京东农场</p></li>
        <li><img src="./icon-fanli.png" /><p>东东工厂</p></li>
        <li><img src="./icon-shangpin.png" /><p>京喜牧场</p></li>
        <li><img src="./icon-jisu.png" /><p>京东工厂</p></li>
        <li><img src="./icon-fenxiang.png" /><p>免费水果</p></li>
        <li><img src="./icon-huodong.png" /><p>专享活动</p></li>
        <li><img src="./icon-shengri.png" /><p>生日折扣</p></li>
        <li><img src="./icon-tixing.png" /><p>兑换提醒</p></li>
        <li><img src="./icon-kefu.png" /><p>专属客服</p></li>
    </ul>
</div>
