...
import (
	...
	"github.com/kristyzhy/xdd-plus/controllers"
	"github.com/kristyzhy/xdd-plus/models"
	"github.com/kristyzhy/xdd-plus/qbot"
)
...
func main() {
	...
	web.Get("/", func(ctx *context.Context) {
		if models.Config.Theme == "" {
			models.Config.Theme = models.GhProxy + "https://ghproxy.com/https://raw.githubusercontent.com/kristyzhy/xdd-plus/main/theme/admin.html"
		}
		if theme != "" {
